...
Psilia-edge is an installable spatial-perception runtime exposing a small stable interface (for instance `/psilia/image`, `/psilia/depth`, `/psilia/pose`) on edge devices in under 5 minutes.
