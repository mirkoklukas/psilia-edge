"""
Depth preview node — subscribes to /psilia/stereo/depth/image (32FC1), applies a colormap,
...
class DepthPreviewNode(Node):
    ...
    def __node_init__(self):
        ...
        self.create_subscription(Image, "/psilia/stereo/rect/image", self._on_rectified, 1)
