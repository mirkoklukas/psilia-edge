...
from psilia.utils import get_root_dir
...
def get_repo_dir() -> Path:
    """Return the repository root directory (the dir containing pyproject.toml).
...
def get_web_dir() -> Path:
    """Return the directory holding the browser UI assets (`<repo>/web`)."""
    return get_repo_dir() / "web"
