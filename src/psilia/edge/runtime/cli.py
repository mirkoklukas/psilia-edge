...
def attach() -> None:
    ...
    from psilia.edge.runtime.core import is_base_layer_running
...
def _run_attach() -> None:
    ...
    from psilia.edge.runtime.core import SpatialRequirementsError
    ...
    def do_spatial_start():
        ...
        status_style = "yellow"
        try:
            from psilia.edge.runtime.core import start_spatial_layer
...
def run_ui() -> None:
    ...
    from psilia.edge.runtime.app import run
...
def lite(
    ...
    from psilia.edge.runtime.lite import serve
