...
from psilia.edge.runtime.config import RUN_DIR, get_api_port, read_config
...
def resolve_camera() -> ResolverResult:
    ...
    from psilia.edge.runtime.sensor import build_sensor_id, find_sensor
...
def resolve_calibration(camera) -> ResolverResult:
    ...
    if cal_override:
        ...
        if not cal_path.is_absolute():
            from psilia.edge.runtime.config import CALIBRATIONS_DIR
