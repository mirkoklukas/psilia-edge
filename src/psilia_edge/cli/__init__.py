...
def pull(device: str = typer.Argument(None, help="Target device name")):
    """Pull recordings from Jetson to laptop."""
    raise NotImplementedError


@app.command()
def push():
    """Push recordings from laptop to cloud."""
    raise NotImplementedError


@app.command()
def sync(device: str = typer.Argument(None, help="Target device name")):
    """Pull from Jetson then push to cloud."""
    raise NotImplementedError


@base_app.command("start")
def base_start():
    """Start the base layer only."""
    raise NotImplementedError
...
def spatial_start():
    """Start the Spatial Runtime (ROS layer) only."""
    raise NotImplementedError


@spatial_app.command("stop")
def spatial_stop():
    """Stop the Spatial Runtime (ROS layer) only."""
    raise NotImplementedError
